...
patches-own [ population country-name elevation rain area value pop current-value bio1 bio2 bio3 bio4 bio5 bio6 bio7 bio8 bio9 bio10 bio11 bio12
  bio13 bio14 bio15 bio16 bio17 bio18 bio19 ARCH INAME
]
...
to display-value-in-patches
  ...
  [
    if(elevation > 0)[
    set value (1 + (area * area-weighting)
        + (rain * rain-weighting)
...
;        + (bio19 * bio19-weighting)
  ...
  create-groups number-of-groups [
    set size 1
    set color black
    move-to one-of patches with [ not shade-of? blue pcolor ]
    setxy startx starty
    set archipelago [ARCH] of patch-here
