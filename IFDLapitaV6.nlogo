...
(Agent based IdealFreeDistribution)
...
(how to use the model, including a description of each of the items in the Interface tab
	...
	press display values as patches
	press go
	once complete press display-order

	dont touch range expantion untill you look at the code. its gloriously slow
	
	press setup to start again

	if you press display values as patches more than once it will have too many agents
